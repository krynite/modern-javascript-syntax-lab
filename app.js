...
console.log(`localLang is Null. lang is :${lang}`)
// ans: localLang is Null. lang is :en

localLangConfig = 'es';
lang = localLangConfig || 'en'

console.log(`localLang is es. lang is :${lang}`)
// ans: localLang is es. lang is :es

//---------------------------------------------------------------
// ! 10.2: Set website theme
// Intro: In this exercise, you'll construct a single line of code that assigns //        a default value to a variable named `theme` using the logical OR 
